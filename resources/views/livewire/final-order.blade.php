<div>
        ...
        .
        @else
        <div class="info-box bg-warning d-flex align-items-center justify-content-center" wire:click='$dispatchTo("form-pago","formPago",{ tipo: "orden" })' style="cursor: pointer;">
