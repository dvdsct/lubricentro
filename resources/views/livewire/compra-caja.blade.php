        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="supplierOrderModalLabel"> <strong> INGRESO/EXTRACCION DE CAJA </strong> </h5>
                ...
                <div class="modal-body">
                    <!-- INGRESO O EXTRACCION DE DINERO -->
                    <div class="row ml-1">
                        <div class="mb-3">
                            ...
                            @error('inOut')
                            <strong> <span class="text-danger ml-2">{{ $message }}</span> </strong>
                            @enderror
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" form="supplierOrderForm" wire:click="pagar">Continuar</button>
                </div>
            </div>
        </div>
    </div>
