                            ...
                            <tr>
                                ...
                                @if ($producto->estado == 1)
                                    ...
                                    <td>
                                        @if ($editPrecio)
                                            <input type="text" class="form-control" style="width: 145px;"
                                                placeholder="Ingresar Precio" wire:model='precioPres'
                                                wire:keydown.enter='addCantidad({{ $producto->id }})'>
                                            @error('precioPres')
                                                {{ $message }}
                                            @enderror
                                        @else
                                            $ {{ $producto->precio }}
                                            <button wire:click='editPrecioPres'>lapiz</button>
                                        @endif
                                ...
                                @if ($producto->estado == 2)
                                    ...
                                    <td class="text-right project-actions" style="width: 200px;">
                                        ...
                                        <a class="btn btn-danger btn-sm" wire:click='delProd({{ $producto->id }})'
                                            wire:confirm="Estas seguro de que desesas eliminar este articulo?">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 80vh; overflow-y: auto;">
                    ...
                    <div class="pb-2 input-group input-group-sm" style="width: 300px;">
                        <input type="text" class="float-right form-control" wire:model='query' wire:keydown='search'
                            placeholder="Buscar">
                        <div class="input-group-append">
                            <button class="btn btn-default">
                                <i class="fas fa-search"></i>
