                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="mb-3">
                                <label for="tipoFactura" class="form-label">Tipo de Pago</label>
                                <select wire:model="tipoFactura" id="tipoFactura" class="form-select">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="montoPagado" type="number" id="montoPagado"
                                    class="form-control">
                            </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" wire:click='pagar'>Save changes</button>
                    </div>
                </div>
