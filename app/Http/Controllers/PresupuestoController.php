...
class PresupuestoController extends Controller
{
    ...
    {
        // Permitir acceso a admin, cajero, spectator o a quien tenga el permiso 'presupuestos'
        $this->middleware('role_or_permission:admin|cajero|spectator|presupuestos');
    }
